...
// End Cross Module References
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bDebuffValid_MetaData[];
#endif
		static void NewProp_bDebuffValid_SetBit(void* Obj);
		static const UECodeGen_Private::FBoolPropertyParams NewProp_bDebuffValid;
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UDamageGameplayAbilityBase_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UDamageGameplayAbilityBase_MakeDamageEffectParamsFromClassDefaults, "MakeDamageEffectParamsFromClassDefaults" }, // 644267565
	};
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDamageGameplayAbilityBase_Statics::NewProp_bIsBasicAttack_MetaData[] = {
		{ "Category", "Damage" },
		{ "ModuleRelativePath", "AbilitySystem/Abilities/DamageGameplayAbilityBase.h" },
	};
#endif
	void Z_Construct_UClass_UDamageGameplayAbilityBase_Statics::NewProp_bIsBasicAttack_SetBit(void* Obj)
	{
		((UDamageGameplayAbilityBase*)Obj)->bIsBasicAttack = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UDamageGameplayAbilityBase_Statics::NewProp_bIsBasicAttack = { "bIsBasicAttack", nullptr, (EPropertyFlags)0x0010000000010001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UDamageGameplayAbilityBase), &Z_Construct_UClass_UDamageGameplayAbilityBase_Statics::NewProp_bIsBasicAttack_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDamageGameplayAbilityBase_Statics::NewProp_bIsBasicAttack_MetaData), Z_Construct_UClass_UDamageGameplayAbilityBase_Statics::NewProp_bIsBasicAttack_MetaData) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDamageGameplayAbilityBase_Statics::NewProp_bDebuffValid_MetaData[] = {
		{ "Category", "Damage" },
		{ "ModuleRelativePath", "AbilitySystem/Abilities/DamageGameplayAbilityBase.h" },
	};
#endif
	void Z_Construct_UClass_UDamageGameplayAbilityBase_Statics::NewProp_bDebuffValid_SetBit(void* Obj)
	{
		((UDamageGameplayAbilityBase*)Obj)->bDebuffValid = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UDamageGameplayAbilityBase_Statics::NewProp_bDebuffValid = { "bDebuffValid", nullptr, (EPropertyFlags)0x0010000000010001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UDamageGameplayAbilityBase), &Z_Construct_UClass_UDamageGameplayAbilityBase_Statics::NewProp_bDebuffValid_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDamageGameplayAbilityBase_Statics::NewProp_bDebuffValid_MetaData), Z_Construct_UClass_UDamageGameplayAbilityBase_Statics::NewProp_bDebuffValid_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UDamageGameplayAbilityBase_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UDamageGameplayAbilityBase_Statics::NewProp_bIsBasicAttack,
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UDamageGameplayAbilityBase_Statics::NewProp_bDebuffValid,
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SeniorProject_5_3_Source_SeniorProject_AbilitySystem_Abilities_DamageGameplayAbilityBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDamageGameplayAbilityBase, UDamageGameplayAbilityBase::StaticClass, TEXT("UDamageGameplayAbilityBase"), &Z_Registration_Info_UClass_UDamageGameplayAbilityBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDamageGameplayAbilityBase), 2629123147U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SeniorProject_5_3_Source_SeniorProject_AbilitySystem_Abilities_DamageGameplayAbilityBase_h_275005662(TEXT("/Script/SeniorProject"),

...
// End Cross Module References
	DEFINE_FUNCTION(UProjectileSpellBase::execSpawnHomingProjectile)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->SpawnHomingProjectile(Z_Param_Target,Z_Param_Out_ProjectileTargetLocation,Z_Param_Out_SocketTag,Z_Param_bOverridePitch,Z_Param_PitchOverride);
		P_NATIVE_END;
	}
	...
	DEFINE_FUNCTION(UProjectileSpellBase::execSpawnMeteor)
	{
		P_GET_STRUCT_REF(FVector,Z_Param_Out_AimLocation);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->SpawnMeteor(Z_Param_Out_AimLocation);
		P_NATIVE_END;
	}
	void UProjectileSpellBase::StaticRegisterNativesUProjectileSpellBase()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			{ "SpawnHomingProjectile", &UProjectileSpellBase::execSpawnHomingProjectile },
			{ "SpawnMeteor", &UProjectileSpellBase::execSpawnMeteor },
			{ "SpawnProjectile", &UProjectileSpellBase::execSpawnProjectile },
		};
		FNativeFunctionRegistrar::RegisterFunctions(Class, Funcs, UE_ARRAY_COUNT(Funcs));
	}
	struct Z_Construct_UFunction_UProjectileSpellBase_SpawnHomingProjectile_Statics
	{
		struct ProjectileSpellBase_eventSpawnHomingProjectile_Parms
		{
			AActor* Target;
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UProjectileSpellBase_SpawnHomingProjectile_Statics::NewProp_Target = { "Target", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ProjectileSpellBase_eventSpawnHomingProjectile_Parms, Target), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UProjectileSpellBase_SpawnHomingProjectile_Statics::NewProp_ProjectileTargetLocation_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UProjectileSpellBase_SpawnHomingProjectile_Statics::NewProp_ProjectileTargetLocation = { "ProjectileTargetLocation", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ProjectileSpellBase_eventSpawnHomingProjectile_Parms, ProjectileTargetLocation), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UProjectileSpellBase_SpawnHomingProjectile_Statics::NewProp_ProjectileTargetLocation_MetaData), Z_Construct_UFunction_UProjectileSpellBase_SpawnHomingProjectile_Statics::NewProp_ProjectileTargetLocation_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UProjectileSpellBase_SpawnHomingProjectile_Statics::NewProp_SocketTag_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UProjectileSpellBase_SpawnHomingProjectile_Statics::NewProp_SocketTag = { "SocketTag", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ProjectileSpellBase_eventSpawnHomingProjectile_Parms, SocketTag), Z_Construct_UScriptStruct_FGameplayTag, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UProjectileSpellBase_SpawnHomingProjectile_Statics::NewProp_SocketTag_MetaData), Z_Construct_UFunction_UProjectileSpellBase_SpawnHomingProjectile_Statics::NewProp_SocketTag_MetaData) }; // 2083603574
	void Z_Construct_UFunction_UProjectileSpellBase_SpawnHomingProjectile_Statics::NewProp_bOverridePitch_SetBit(void* Obj)
	{
		((ProjectileSpellBase_eventSpawnHomingProjectile_Parms*)Obj)->bOverridePitch = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UProjectileSpellBase_SpawnHomingProjectile_Statics::NewProp_bOverridePitch = { "bOverridePitch", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(ProjectileSpellBase_eventSpawnHomingProjectile_Parms), &Z_Construct_UFunction_UProjectileSpellBase_SpawnHomingProjectile_Statics::NewProp_bOverridePitch_SetBit, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UProjectileSpellBase_SpawnHomingProjectile_Statics::NewProp_PitchOverride = { "PitchOverride", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ProjectileSpellBase_eventSpawnHomingProjectile_Parms, PitchOverride), METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UProjectileSpellBase_SpawnHomingProjectile_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UProjectileSpellBase_SpawnHomingProjectile_Statics::NewProp_Target,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UProjectileSpellBase_SpawnHomingProjectile_Statics::NewProp_ProjectileTargetLocation,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UProjectileSpellBase_SpawnHomingProjectile_Statics::NewProp_SocketTag,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UProjectileSpellBase_SpawnHomingProjectile_Statics::NewProp_bOverridePitch,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UProjectileSpellBase_SpawnHomingProjectile_Statics::NewProp_PitchOverride,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UProjectileSpellBase_SpawnHomingProjectile_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "AbilitySystem/Abilities/ProjectileSpellBase.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UProjectileSpellBase_SpawnHomingProjectile_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UProjectileSpellBase, nullptr, "SpawnHomingProjectile", nullptr, nullptr, Z_Construct_UFunction_UProjectileSpellBase_SpawnHomingProjectile_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UProjectileSpellBase_SpawnHomingProjectile_Statics::PropPointers), sizeof(Z_Construct_UFunction_UProjectileSpellBase_SpawnHomingProjectile_Statics::ProjectileSpellBase_eventSpawnHomingProjectile_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04C80401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UProjectileSpellBase_SpawnHomingProjectile_Statics::Function_MetaDataParams), Z_Construct_UFunction_UProjectileSpellBase_SpawnHomingProjectile_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UProjectileSpellBase_SpawnHomingProjectile_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UProjectileSpellBase_SpawnHomingProjectile_Statics::ProjectileSpellBase_eventSpawnHomingProjectile_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_UProjectileSpellBase_SpawnHomingProjectile()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UProjectileSpellBase_SpawnHomingProjectile_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_UProjectileSpellBase_SpawnMeteor_Statics
	{
		struct ProjectileSpellBase_eventSpawnMeteor_Parms
		{
			FVector AimLocation;
		};
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UProjectileSpellBase_SpawnMeteor_Statics::NewProp_AimLocation_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UProjectileSpellBase_SpawnMeteor_Statics::NewProp_AimLocation = { "AimLocation", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ProjectileSpellBase_eventSpawnMeteor_Parms, AimLocation), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UProjectileSpellBase_SpawnMeteor_Statics::NewProp_AimLocation_MetaData), Z_Construct_UFunction_UProjectileSpellBase_SpawnMeteor_Statics::NewProp_AimLocation_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UProjectileSpellBase_SpawnMeteor_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UProjectileSpellBase_SpawnMeteor_Statics::NewProp_AimLocation,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UProjectileSpellBase_SpawnMeteor_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "AbilitySystem/Abilities/ProjectileSpellBase.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UProjectileSpellBase_SpawnMeteor_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UProjectileSpellBase, nullptr, "SpawnMeteor", nullptr, nullptr, Z_Construct_UFunction_UProjectileSpellBase_SpawnMeteor_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UProjectileSpellBase_SpawnMeteor_Statics::PropPointers), sizeof(Z_Construct_UFunction_UProjectileSpellBase_SpawnMeteor_Statics::ProjectileSpellBase_eventSpawnMeteor_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04C80401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UProjectileSpellBase_SpawnMeteor_Statics::Function_MetaDataParams), Z_Construct_UFunction_UProjectileSpellBase_SpawnMeteor_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UProjectileSpellBase_SpawnMeteor_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UProjectileSpellBase_SpawnMeteor_Statics::ProjectileSpellBase_eventSpawnMeteor_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_UProjectileSpellBase_SpawnMeteor()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UProjectileSpellBase_SpawnMeteor_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UProjectileSpellBase_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UProjectileSpellBase_SpawnHomingProjectile, "SpawnHomingProjectile" }, // 854185437
		{ &Z_Construct_UFunction_UProjectileSpellBase_SpawnMeteor, "SpawnMeteor" }, // 1878216627
		{ &Z_Construct_UFunction_UProjectileSpellBase_SpawnProjectile, "SpawnProjectile" }, // 3475530667
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SeniorProject_5_3_Source_SeniorProject_AbilitySystem_Abilities_ProjectileSpellBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UProjectileSpellBase, UProjectileSpellBase::StaticClass, TEXT("UProjectileSpellBase"), &Z_Registration_Info_UClass_UProjectileSpellBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UProjectileSpellBase), 4098510467U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SeniorProject_5_3_Source_SeniorProject_AbilitySystem_Abilities_ProjectileSpellBase_h_2093286398(TEXT("/Script/SeniorProject"),

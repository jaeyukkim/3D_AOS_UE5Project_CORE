...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_SeniorProject_EEffectApplicationPolicy_Statics::Enum_MetaDataParams[] = {
		...
		{ "ModuleRelativePath", "Actor/Default/EffectActorBase.h" },
	};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AEffectActorBase_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AEffectActorBase_ApplyEffectToTarget, "ApplyEffectToTarget" }, // 1164981001
		{ &Z_Construct_UFunction_AEffectActorBase_OnEndOverlap, "OnEndOverlap" }, // 579796377
		{ &Z_Construct_UFunction_AEffectActorBase_OnOverlap, "OnOverlap" }, // 3480948493
	};
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AEffectActorBase_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "Actor/Default/EffectActorBase.h" },
		{ "ModuleRelativePath", "Actor/Default/EffectActorBase.h" },
	};
#endif
	...
	struct Z_CompiledInDeferFile_FID_SeniorProject_5_3_Source_SeniorProject_Actor_Default_EffectActorBase_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SeniorProject_5_3_Source_SeniorProject_Actor_Default_EffectActorBase_h_Statics::EnumInfo[] = {
		{ EEffectApplicationPolicy_StaticEnum, TEXT("EEffectApplicationPolicy"), &Z_Registration_Info_UEnum_EEffectApplicationPolicy, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 206548180U) },
		{ EEffectRemovalPolicy_StaticEnum, TEXT("EEffectRemovalPolicy"), &Z_Registration_Info_UEnum_EEffectRemovalPolicy, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 110040209U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SeniorProject_5_3_Source_SeniorProject_Actor_Default_EffectActorBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AEffectActorBase, AEffectActorBase::StaticClass, TEXT("AEffectActorBase"), &Z_Registration_Info_UClass_AEffectActorBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AEffectActorBase), 3814606166U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SeniorProject_5_3_Source_SeniorProject_Actor_Default_EffectActorBase_h_4208131913(TEXT("/Script/SeniorProject"),
		Z_CompiledInDeferFile_FID_SeniorProject_5_3_Source_SeniorProject_Actor_Default_EffectActorBase_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_SeniorProject_5_3_Source_SeniorProject_Actor_Default_EffectActorBase_h_Statics::ClassInfo),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_SeniorProject_5_3_Source_SeniorProject_Actor_Default_EffectActorBase_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_SeniorProject_5_3_Source_SeniorProject_Actor_Default_EffectActorBase_h_Statics::EnumInfo));

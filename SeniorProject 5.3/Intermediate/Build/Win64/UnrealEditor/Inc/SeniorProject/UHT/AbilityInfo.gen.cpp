...
template<> SENIORPROJECT_API UScriptStruct* StaticStruct<FAbilityInfoBase>()
{
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_CharacterTag_MetaData[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FAbilityInfoBase_Statics::NewProp_CharacterTag_MetaData[] = {
		{ "Category", "AbilityInfoBase" },
		{ "ModuleRelativePath", "AbilitySystem/Data/AbilityInfo.h" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAbilityInfoBase_Statics::NewProp_CharacterTag = { "CharacterTag", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FAbilityInfoBase, CharacterTag), Z_Construct_UScriptStruct_FGameplayTag, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAbilityInfoBase_Statics::NewProp_CharacterTag_MetaData), Z_Construct_UScriptStruct_FAbilityInfoBase_Statics::NewProp_CharacterTag_MetaData) }; // 2083603574
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FAbilityInfoBase_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FAbilityInfoBase_Statics::NewProp_CharacterTag,
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UAbilityInfo_Statics::NewProp_AbilityInformation_Inner = { "AbilityInformation", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FAbilityInfoBase, METADATA_PARAMS(0, nullptr) }; // 84626540
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SeniorProject_5_3_Source_SeniorProject_AbilitySystem_Data_AbilityInfo_h_Statics::ScriptStructInfo[] = {
		{ FAbilityInfoBase::StaticStruct, Z_Construct_UScriptStruct_FAbilityInfoBase_Statics::NewStructOps, TEXT("AbilityInfoBase"), &Z_Registration_Info_UScriptStruct_AbilityInfoBase, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAbilityInfoBase), 84626540U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SeniorProject_5_3_Source_SeniorProject_AbilitySystem_Data_AbilityInfo_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAbilityInfo, UAbilityInfo::StaticClass, TEXT("UAbilityInfo"), &Z_Registration_Info_UClass_UAbilityInfo, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAbilityInfo), 4152168911U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SeniorProject_5_3_Source_SeniorProject_AbilitySystem_Data_AbilityInfo_h_482474042(TEXT("/Script/SeniorProject"),

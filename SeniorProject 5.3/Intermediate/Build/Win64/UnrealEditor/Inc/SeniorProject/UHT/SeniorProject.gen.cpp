...
// End Cross Module References
	...
	static UEnum* ECharacterState_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ECharacterState.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_SeniorProject_ECharacterState, (UObject*)Z_Construct_UPackage__Script_SeniorProject(), TEXT("ECharacterState"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_SeniorProject_ECharacterState_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_SeniorProject_ECharacterState_Statics::Enum_MetaDataParams), Z_Construct_UEnum_SeniorProject_ECharacterState_Statics::Enum_MetaDataParams)
	};
	...
	static UEnum* EMinionState_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EMinionState.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_SeniorProject_EMinionState, (UObject*)Z_Construct_UPackage__Script_SeniorProject(), TEXT("EMinionState"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_SeniorProject_EMinionState_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_SeniorProject_EMinionState_Statics::Enum_MetaDataParams), Z_Construct_UEnum_SeniorProject_EMinionState_Statics::Enum_MetaDataParams)
	};
	...
	static UEnum* EAttackDirection_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EAttackDirection.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_SeniorProject_EAttackDirection, (UObject*)Z_Construct_UPackage__Script_SeniorProject(), TEXT("EAttackDirection"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_SeniorProject_EAttackDirection_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_SeniorProject_EAttackDirection_Statics::Enum_MetaDataParams), Z_Construct_UEnum_SeniorProject_EAttackDirection_Statics::Enum_MetaDataParams)
	};
	...
	struct Z_CompiledInDeferFile_FID_SeniorProject_5_3_Source_SeniorProject_SeniorProject_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SeniorProject_5_3_Source_SeniorProject_SeniorProject_h_Statics::EnumInfo[] = {
		{ ECharacterState_StaticEnum, TEXT("ECharacterState"), &Z_Registration_Info_UEnum_ECharacterState, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 462776798U) },
		{ EMinionState_StaticEnum, TEXT("EMinionState"), &Z_Registration_Info_UEnum_EMinionState, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2291304702U) },
		{ EAttackDirection_StaticEnum, TEXT("EAttackDirection"), &Z_Registration_Info_UEnum_EAttackDirection, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 801878163U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SeniorProject_5_3_Source_SeniorProject_SeniorProject_h_2441053268(TEXT("/Script/SeniorProject"),
		nullptr, 0,
		nullptr, 0,
		Z_CompiledInDeferFile_FID_SeniorProject_5_3_Source_SeniorProject_SeniorProject_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_SeniorProject_5_3_Source_SeniorProject_SeniorProject_h_Statics::EnumInfo));

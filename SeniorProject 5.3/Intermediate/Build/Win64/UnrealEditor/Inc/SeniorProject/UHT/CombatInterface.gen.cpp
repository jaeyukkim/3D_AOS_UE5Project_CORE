...
// End Cross Module References
	...
	DEFINE_FUNCTION(ICombatInterface::execApplyDebuffEffect)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->ApplyDebuffEffect_Implementation(Z_Param_Out_DebuffTag,Z_Param_DebuffCoefficient,Z_Param_DebuffDuration,Z_Param_DebuffFrequency);
		P_NATIVE_END;
	}
	...
	struct CombatInterface_eventApplyDebuffEffect_Parms
	{
	...
	{
		check(0 && "Do not directly call Event functions in Interfaces. Call Execute_ApplyDebuffEffect instead.");
	}
	...
	void UCombatInterface::StaticRegisterNativesUCombatInterface()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			{ "ApplyDebuffEffect", &ICombatInterface::execApplyDebuffEffect },
	...
	struct Z_Construct_UFunction_UCombatInterface_ApplyDebuffEffect_Statics
	{
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UCombatInterface_ApplyDebuffEffect_Statics::NewProp_DebuffTag_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UCombatInterface_ApplyDebuffEffect_Statics::NewProp_DebuffTag = { "DebuffTag", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(CombatInterface_eventApplyDebuffEffect_Parms, DebuffTag), Z_Construct_UScriptStruct_FGameplayTag, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UCombatInterface_ApplyDebuffEffect_Statics::NewProp_DebuffTag_MetaData), Z_Construct_UFunction_UCombatInterface_ApplyDebuffEffect_Statics::NewProp_DebuffTag_MetaData) }; // 2083603574
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UCombatInterface_ApplyDebuffEffect_Statics::NewProp_DebuffCoefficient_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UCombatInterface_ApplyDebuffEffect_Statics::NewProp_DebuffCoefficient = { "DebuffCoefficient", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(CombatInterface_eventApplyDebuffEffect_Parms, DebuffCoefficient), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UCombatInterface_ApplyDebuffEffect_Statics::NewProp_DebuffCoefficient_MetaData), Z_Construct_UFunction_UCombatInterface_ApplyDebuffEffect_Statics::NewProp_DebuffCoefficient_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UCombatInterface_ApplyDebuffEffect_Statics::NewProp_DebuffDuration_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UCombatInterface_ApplyDebuffEffect_Statics::NewProp_DebuffDuration = { "DebuffDuration", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(CombatInterface_eventApplyDebuffEffect_Parms, DebuffDuration), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UCombatInterface_ApplyDebuffEffect_Statics::NewProp_DebuffDuration_MetaData), Z_Construct_UFunction_UCombatInterface_ApplyDebuffEffect_Statics::NewProp_DebuffDuration_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UCombatInterface_ApplyDebuffEffect_Statics::NewProp_DebuffFrequency_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UCombatInterface_ApplyDebuffEffect_Statics::NewProp_DebuffFrequency = { "DebuffFrequency", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(CombatInterface_eventApplyDebuffEffect_Parms, DebuffFrequency), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UCombatInterface_ApplyDebuffEffect_Statics::NewProp_DebuffFrequency_MetaData), Z_Construct_UFunction_UCombatInterface_ApplyDebuffEffect_Statics::NewProp_DebuffFrequency_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UCombatInterface_ApplyDebuffEffect_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UCombatInterface_ApplyDebuffEffect_Statics::NewProp_DebuffTag,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UCombatInterface_ApplyDebuffEffect_Statics::NewProp_DebuffCoefficient,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UCombatInterface_ApplyDebuffEffect_Statics::NewProp_DebuffDuration,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UCombatInterface_ApplyDebuffEffect_Statics::NewProp_DebuffFrequency,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UCombatInterface_ApplyDebuffEffect_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Interface/CombatInterface.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UCombatInterface_ApplyDebuffEffect_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UCombatInterface, nullptr, "ApplyDebuffEffect", nullptr, nullptr, Z_Construct_UFunction_UCombatInterface_ApplyDebuffEffect_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UCombatInterface_ApplyDebuffEffect_Statics::PropPointers), sizeof(CombatInterface_eventApplyDebuffEffect_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C420C00, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UCombatInterface_ApplyDebuffEffect_Statics::Function_MetaDataParams), Z_Construct_UFunction_UCombatInterface_ApplyDebuffEffect_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UCombatInterface_ApplyDebuffEffect_Statics::PropPointers) < 2048);
	static_assert(sizeof(CombatInterface_eventApplyDebuffEffect_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_UCombatInterface_ApplyDebuffEffect()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UCombatInterface_ApplyDebuffEffect_Statics::FuncParams);
		}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UCombatInterface_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UCombatInterface_ApplyDebuffEffect, "ApplyDebuffEffect" }, // 1323827070
	...
	static FName NAME_UCombatInterface_ApplyDebuffEffect = FName(TEXT("ApplyDebuffEffect"));
	void ICombatInterface::Execute_ApplyDebuffEffect(UObject* O, FGameplayTag const& DebuffTag, const float DebuffCoefficient, const float DebuffDuration, const float DebuffFrequency)
	{
		check(O != NULL);
		check(O->GetClass()->ImplementsInterface(UCombatInterface::StaticClass()));
		CombatInterface_eventApplyDebuffEffect_Parms Parms;
		UFunction* const Func = O->FindFunction(NAME_UCombatInterface_ApplyDebuffEffect);
		if (Func)
		{
			Parms.DebuffTag=DebuffTag;
			Parms.DebuffCoefficient=DebuffCoefficient;
			Parms.DebuffDuration=DebuffDuration;
			Parms.DebuffFrequency=DebuffFrequency;
			O->ProcessEvent(Func, &Parms);
		}
		else if (auto I = (ICombatInterface*)(O->GetNativeInterfaceAddress(UCombatInterface::StaticClass())))
		{
			I->ApplyDebuffEffect_Implementation(DebuffTag,DebuffCoefficient,DebuffDuration,DebuffFrequency);
		}
	}

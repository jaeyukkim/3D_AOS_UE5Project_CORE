...
// Cross Module References
	...
	SENIORPROJECT_API UFunction* Z_Construct_UDelegateFunction_SeniorProject_UpdateSelectedCharacterDelegate__DelegateSignature();
...
void FUpdateMinionTargetsSignature_DelegateWrapper(const FMulticastScriptDelegate& UpdateMinionTargetsSignature)
{
	...
	struct Z_Construct_UDelegateFunction_SeniorProject_UpdateSelectedCharacterDelegate__DelegateSignature_Statics
	{
		struct _Script_SeniorProject_eventUpdateSelectedCharacterDelegate_Parms
		{
			APlayerStateBase* PS;
		};
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UDelegateFunction_SeniorProject_UpdateSelectedCharacterDelegate__DelegateSignature_Statics::NewProp_PS = { "PS", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_SeniorProject_eventUpdateSelectedCharacterDelegate_Parms, PS), Z_Construct_UClass_APlayerStateBase_NoRegister, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_SeniorProject_UpdateSelectedCharacterDelegate__DelegateSignature_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_SeniorProject_UpdateSelectedCharacterDelegate__DelegateSignature_Statics::NewProp_PS,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_SeniorProject_UpdateSelectedCharacterDelegate__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "GameSetting/MyGameModeBase.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_SeniorProject_UpdateSelectedCharacterDelegate__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_SeniorProject, nullptr, "UpdateSelectedCharacterDelegate__DelegateSignature", nullptr, nullptr, Z_Construct_UDelegateFunction_SeniorProject_UpdateSelectedCharacterDelegate__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_SeniorProject_UpdateSelectedCharacterDelegate__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_SeniorProject_UpdateSelectedCharacterDelegate__DelegateSignature_Statics::_Script_SeniorProject_eventUpdateSelectedCharacterDelegate_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_SeniorProject_UpdateSelectedCharacterDelegate__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_SeniorProject_UpdateSelectedCharacterDelegate__DelegateSignature_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_SeniorProject_UpdateSelectedCharacterDelegate__DelegateSignature_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UDelegateFunction_SeniorProject_UpdateSelectedCharacterDelegate__DelegateSignature_Statics::_Script_SeniorProject_eventUpdateSelectedCharacterDelegate_Parms) < MAX_uint16);
	UFunction* Z_Construct_UDelegateFunction_SeniorProject_UpdateSelectedCharacterDelegate__DelegateSignature()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UDelegateFunction_SeniorProject_UpdateSelectedCharacterDelegate__DelegateSignature_Statics::FuncParams);
		}
		return ReturnFunction;
	}
void FUpdateSelectedCharacterDelegate_DelegateWrapper(const FMulticastScriptDelegate& UpdateSelectedCharacterDelegate, APlayerStateBase* PS)
{
	struct _Script_SeniorProject_eventUpdateSelectedCharacterDelegate_Parms
	{
		APlayerStateBase* PS;
	};
	_Script_SeniorProject_eventUpdateSelectedCharacterDelegate_Parms Parms;
	Parms.PS=PS;
	UpdateSelectedCharacterDelegate.ProcessMulticastDelegate<UObject>(&Parms);
}
	...
	DEFINE_FUNCTION(AMyGameModeBase::execOnTurretDestroyed)
	{
		...
		P_GET_STRUCT_REF(FGameplayTag,Z_Param_Out_TurretLevelTag);
		P_GET_STRUCT_REF(FGameplayTag,Z_Param_Out_TeamTag);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->OnTurretDestroyed(Z_Param_Out_LineTag,Z_Param_Out_TurretLevelTag,Z_Param_Out_TeamTag);
		P_NATIVE_END;
	}
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_AMyGameModeBase_OnTurretDestroyed_Statics::NewProp_LineTag = { "LineTag", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MyGameModeBase_eventOnTurretDestroyed_Parms, LineTag), Z_Construct_UScriptStruct_FGameplayTag, METADATA_PARAMS(0, nullptr) }; // 2083603574
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_AMyGameModeBase_OnTurretDestroyed_Statics::NewProp_TurretLevelTag = { "TurretLevelTag", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MyGameModeBase_eventOnTurretDestroyed_Parms, TurretLevelTag), Z_Construct_UScriptStruct_FGameplayTag, METADATA_PARAMS(0, nullptr) }; // 2083603574
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_AMyGameModeBase_OnTurretDestroyed_Statics::NewProp_TeamTag = { "TeamTag", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MyGameModeBase_eventOnTurretDestroyed_Parms, TeamTag), Z_Construct_UScriptStruct_FGameplayTag, METADATA_PARAMS(0, nullptr) }; // 2083603574
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AMyGameModeBase_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_AMyGameModeBase_OnTurretDestroyed, "OnTurretDestroyed" }, // 2681349081
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SeniorProject_5_3_Source_SeniorProject_GameSetting_MyGameModeBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AMyGameModeBase, AMyGameModeBase::StaticClass, TEXT("AMyGameModeBase"), &Z_Registration_Info_UClass_AMyGameModeBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMyGameModeBase), 2983538980U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SeniorProject_5_3_Source_SeniorProject_GameSetting_MyGameModeBase_h_1186341761(TEXT("/Script/SeniorProject"),

...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMyCharacterStatComponent_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMyCharacterStatComponent_Statics::NewProp_IsPlayerDead = { "IsPlayerDead", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UMyCharacterStatComponent), &Z_Construct_UClass_UMyCharacterStatComponent_Statics::NewProp_IsPlayerDead_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMyCharacterStatComponent_Statics::NewProp_IsPlayerDead_MetaData), Z_Construct_UClass_UMyCharacterStatComponent_Statics::NewProp_IsPlayerDead_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMyCharacterStatComponent_Statics::ClassParams = {
		...
		0,
		0x00B000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMyCharacterStatComponent_Statics::Class_MetaDataParams), Z_Construct_UClass_UMyCharacterStatComponent_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMyCharacterStatComponent_Statics::PropPointers) < 2048);

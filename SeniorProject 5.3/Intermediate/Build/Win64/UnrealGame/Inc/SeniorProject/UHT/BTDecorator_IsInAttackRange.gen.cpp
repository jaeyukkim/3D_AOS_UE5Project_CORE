...
#include "SeniorProject/Character/Enemy/EnemyBase/CustomBehaviorTree/BTDecorator_IsInAttackRange.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeBTDecorator_IsInAttackRange() {}
// Cross Module References
	AIMODULE_API UClass* Z_Construct_UClass_UBTDecorator();
	SENIORPROJECT_API UClass* Z_Construct_UClass_UBTDecorator_IsInAttackRange();
	SENIORPROJECT_API UClass* Z_Construct_UClass_UBTDecorator_IsInAttackRange_NoRegister();
...
// End Cross Module References
...
#endif
		{ "IncludePath", "Character/Enemy/EnemyBase/CustomBehaviorTree/BTDecorator_IsInAttackRange.h" },
		{ "ModuleRelativePath", "Character/Enemy/EnemyBase/CustomBehaviorTree/BTDecorator_IsInAttackRange.h" },
#if !UE_BUILD_SHIPPING
	...
	template<> SENIORPROJECT_API UClass* StaticClass<UBTDecorator_IsInAttackRange>()
	{
		return UBTDecorator_IsInAttackRange::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UBTDecorator_IsInAttackRange);
	UBTDecorator_IsInAttackRange::~UBTDecorator_IsInAttackRange() {}
	struct Z_CompiledInDeferFile_FID_SeniorProject_5_3_Source_SeniorProject_Character_Enemy_EnemyBase_CustomBehaviorTree_BTDecorator_IsInAttackRange_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SeniorProject_5_3_Source_SeniorProject_Character_Enemy_EnemyBase_CustomBehaviorTree_BTDecorator_IsInAttackRange_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBTDecorator_IsInAttackRange, UBTDecorator_IsInAttackRange::StaticClass, TEXT("UBTDecorator_IsInAttackRange"), &Z_Registration_Info_UClass_UBTDecorator_IsInAttackRange, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBTDecorator_IsInAttackRange), 1917216013U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SeniorProject_5_3_Source_SeniorProject_Character_Enemy_EnemyBase_CustomBehaviorTree_BTDecorator_IsInAttackRange_h_133127047(TEXT("/Script/SeniorProject"),
		Z_CompiledInDeferFile_FID_SeniorProject_5_3_Source_SeniorProject_Character_Enemy_EnemyBase_CustomBehaviorTree_BTDecorator_IsInAttackRange_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_SeniorProject_5_3_Source_SeniorProject_Character_Enemy_EnemyBase_CustomBehaviorTree_BTDecorator_IsInAttackRange_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);

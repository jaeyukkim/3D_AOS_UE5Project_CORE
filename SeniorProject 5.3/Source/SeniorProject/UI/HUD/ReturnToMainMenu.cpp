...
void UReturnToMainMenu::CreateEndGameWidget_Implementation(bool bDefeat)
{
	
}

void UReturnToMainMenu::ReturnButtonClicked_Implementation()
{
	...
	if (World)
	{
		...
		{
			AMyCharacter* PlayerCharacter = Cast<AMyCharacter>(FirstPlayerController->GetPawn());
			if (PlayerCharacter)
			{

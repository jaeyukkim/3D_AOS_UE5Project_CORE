...
#include "SeniorProject/AIMinions/Kwang.h"
...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AKwang_Statics::Class_MetaDataParams[] = {
		...
		{ "IncludePath", "AIMinions/Kwang.h" },
		{ "ModuleRelativePath", "AIMinions/Kwang.h" },
	};
#endif
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_AKwang_Statics::ClassParams = {
		...
		0,
		0x009000A4u,
		METADATA_PARAMS(Z_Construct_UClass_AKwang_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_AKwang_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_SeniorProject_Source_SeniorProject_AIMinions_Kwang_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SeniorProject_Source_SeniorProject_AIMinions_Kwang_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AKwang, AKwang::StaticClass, TEXT("AKwang"), &Z_Registration_Info_UClass_AKwang, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AKwang), 3345440366U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SeniorProject_Source_SeniorProject_AIMinions_Kwang_h_4050846521(TEXT("/Script/SeniorProject"),
		Z_CompiledInDeferFile_FID_SeniorProject_Source_SeniorProject_AIMinions_Kwang_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_SeniorProject_Source_SeniorProject_AIMinions_Kwang_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);

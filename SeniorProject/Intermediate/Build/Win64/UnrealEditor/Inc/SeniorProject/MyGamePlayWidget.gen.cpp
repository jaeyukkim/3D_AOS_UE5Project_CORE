...
#include "SeniorProject/GameSetting/MyGamePlayWidget.h"
...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UMyGamePlayWidget_OnResumeClicked_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "GameSetting/MyGamePlayWidget.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMyGamePlayWidget_OnResumeClicked_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMyGamePlayWidget, nullptr, "OnResumeClicked", nullptr, nullptr, 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00080401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UMyGamePlayWidget_OnResumeClicked_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UMyGamePlayWidget_OnResumeClicked_Statics::Function_MetaDataParams)) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMyGamePlayWidget_OnRetryGameClicked_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMyGamePlayWidget, nullptr, "OnRetryGameClicked", nullptr, nullptr, 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00080401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UMyGamePlayWidget_OnRetryGameClicked_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UMyGamePlayWidget_OnRetryGameClicked_Statics::Function_MetaDataParams)) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMyGamePlayWidget_OnReturnToTitleClicked_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMyGamePlayWidget, nullptr, "OnReturnToTitleClicked", nullptr, nullptr, 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00080401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UMyGamePlayWidget_OnReturnToTitleClicked_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UMyGamePlayWidget_OnReturnToTitleClicked_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMyGamePlayWidget_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMyGamePlayWidget_OnResumeClicked, "OnResumeClicked" }, // 2629680478
		{ &Z_Construct_UFunction_UMyGamePlayWidget_OnRetryGameClicked, "OnRetryGameClicked" }, // 177136052
		{ &Z_Construct_UFunction_UMyGamePlayWidget_OnReturnToTitleClicked, "OnReturnToTitleClicked" }, // 3168335050
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMyGamePlayWidget_Statics::Class_MetaDataParams[] = {
		{ "Comment", "/**\n * \n */" },
		{ "IncludePath", "GameSetting/MyGamePlayWidget.h" },
		{ "ModuleRelativePath", "GameSetting/MyGamePlayWidget.h" },
	};
#endif
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UMyGamePlayWidget_Statics::NewProp_ResumeButton = { "ResumeButton", nullptr, (EPropertyFlags)0x0020080000080008, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMyGamePlayWidget, ResumeButton), Z_Construct_UClass_UButton_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UMyGamePlayWidget_Statics::NewProp_ResumeButton_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMyGamePlayWidget_Statics::NewProp_ResumeButton_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UMyGamePlayWidget_Statics::NewProp_ReturnToTitleButton = { "ReturnToTitleButton", nullptr, (EPropertyFlags)0x0020080000080008, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMyGamePlayWidget, ReturnToTitleButton), Z_Construct_UClass_UButton_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UMyGamePlayWidget_Statics::NewProp_ReturnToTitleButton_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMyGamePlayWidget_Statics::NewProp_ReturnToTitleButton_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UMyGamePlayWidget_Statics::NewProp_RetryGameButton = { "RetryGameButton", nullptr, (EPropertyFlags)0x0020080000080008, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMyGamePlayWidget, RetryGameButton), Z_Construct_UClass_UButton_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UMyGamePlayWidget_Statics::NewProp_RetryGameButton_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMyGamePlayWidget_Statics::NewProp_RetryGameButton_MetaData)) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMyGamePlayWidget_Statics::ClassParams = {
		...
		0,
		0x00B010A0u,
		METADATA_PARAMS(Z_Construct_UClass_UMyGamePlayWidget_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UMyGamePlayWidget_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_SeniorProject_Source_SeniorProject_GameSetting_MyGamePlayWidget_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SeniorProject_Source_SeniorProject_GameSetting_MyGamePlayWidget_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMyGamePlayWidget, UMyGamePlayWidget::StaticClass, TEXT("UMyGamePlayWidget"), &Z_Registration_Info_UClass_UMyGamePlayWidget, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMyGamePlayWidget), 1057902575U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SeniorProject_Source_SeniorProject_GameSetting_MyGamePlayWidget_h_2751595626(TEXT("/Script/SeniorProject"),
		Z_CompiledInDeferFile_FID_SeniorProject_Source_SeniorProject_GameSetting_MyGamePlayWidget_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_SeniorProject_Source_SeniorProject_GameSetting_MyGamePlayWidget_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);

...
#include "SeniorProject/AIMinions/Melee.h"
...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AMelee_Statics::Class_MetaDataParams[] = {
		...
		{ "IncludePath", "AIMinions/Melee.h" },
		{ "ModuleRelativePath", "AIMinions/Melee.h" },
	};
#endif
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_AMelee_Statics::ClassParams = {
		...
		0,
		0x009000A4u,
		METADATA_PARAMS(Z_Construct_UClass_AMelee_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_AMelee_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_SeniorProject_Source_SeniorProject_AIMinions_Melee_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SeniorProject_Source_SeniorProject_AIMinions_Melee_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AMelee, AMelee::StaticClass, TEXT("AMelee"), &Z_Registration_Info_UClass_AMelee, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMelee), 1606962912U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SeniorProject_Source_SeniorProject_AIMinions_Melee_h_11990302(TEXT("/Script/SeniorProject"),
		Z_CompiledInDeferFile_FID_SeniorProject_Source_SeniorProject_AIMinions_Melee_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_SeniorProject_Source_SeniorProject_AIMinions_Melee_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);

...
void AKwang::SetDefaultSetting()
{
	...
	static ConstructorHelpers::FClassFinder<UAnimInstance> Kwang_Anim(
		TEXT("AnimBlueprint'/Game/BP/KwangAI'"));
	...
	static ConstructorHelpers::FObjectFinder<UAnimMontage> Kwang_Attack1(
		TEXT("AnimMontage'/Game/ParagonKwang/Characters/Heroes/Kwang/Animations/PrimaryAttack_A_Slow_Montage_AI'"));
	...
	static ConstructorHelpers::FObjectFinder<UAnimMontage> Kwang_Attack2(
		TEXT("AnimMontage'/Game/ParagonKwang/Characters/Heroes/Kwang/Animations/PrimaryAttack_B_Slow_Montage_AI'"));
	...
	static ConstructorHelpers::FObjectFinder<UAnimMontage> Kwang_Attack3(
		TEXT("AnimMontage'/Game/ParagonKwang/Characters/Heroes/Kwang/Animations/PrimaryAttack_C_Slow_Montage_AI'"));
	...
	static ConstructorHelpers::FObjectFinder<UAnimMontage> Kwang_Attack4(
		TEXT("AnimMontage'/Game/ParagonKwang/Characters/Heroes/Kwang/Animations/PrimaryAttack_D_Slow_Montage_AI'"));
